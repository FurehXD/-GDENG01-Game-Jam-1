...
public class EventNames {
	...
	public class UI_SeatworkEvents
	{
		public const string ON_CAMPAIGN = "ON_CAMPAIGN";
		public const string ON_MULTIPLAYER = "ON_MULTIPLAYER";
	}

	public class BuildGameSW
	{
		public const string ON_START_GAME = "ON_START_GAME";
        public const string ON_EXIT_GAME = "ON_EXIT_GAME";
		public const string ON_RETURN_TO_MENU = "ON_RETURN_TO_MENU";
    }*/
}
